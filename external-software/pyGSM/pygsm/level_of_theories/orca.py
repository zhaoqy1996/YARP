...
class Orca(Lot):
    ...
    def run(self,geom,multiplicity):
        ...
        path2orca = '/depot/bsavoie/apps/orca_4_1_2/orca'
        ...
        try:
            ...
            try:
                ...
                runscr = '/scratch/brown/'+user+'/'+slurmID+'/'+slurmTASK
            except:
                runscr = '/scratch/brown/'+user+'/'+slurmID
        except:
            orcascr = 'temporcarun'
            runscr = '/scratch/brown/'+user+'/'+orcascr
