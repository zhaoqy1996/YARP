...
if __name__=='__main__':
    sys.path.append('/home/zhao922/bin/pyGSM/pygsm/wrappers')
    sys.path.append('/home/zhao922/bin/pyGSM/pygsm/level_of_theories')
    sys.path.append('/home/zhao922/bin/pyGSM/pygsm/potential_energy_surfaces/')
    sys.path.append('/home/zhao922/bin/pyGSM/pygsm/coordinate_systems')
    sys.path.append('/home/zhao922/bin/pyGSM/pygsm/optimizers')
    ...
    #functional='HF'
    functional='B3LYP'
    filepath1="/home/zhao922/bin/pyGSM/examples/old_examples/old_examples/tests/butadiene_ethene.xyz"
    filepath2="/home/zhao922/bin/pyGSM/examples/old_examples/old_examples/tests/cyclohexene.xyz"
    #filepath1='reactant.xyz'
    #filepath2='product.xyz'

    lot1=Orca.from_options(states=[(1,0)],charge=0,basis=basis,functional='wB97X-D3',nproc=nproc,fnm=filepath1)
    lot2=Orca(lot1.options.copy().set_values({'fnm':filepath2}))
    #lot2=Orca.from_options(states=[(1,0)],charge=0,basis=basis,functional='wB97X-D3',nproc=nproc,fnm=filepath2)
